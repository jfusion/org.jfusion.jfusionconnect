...
class debug {
        ...
        if (is_array($arr) || is_object($arr)) {
            ...
            if (debug::isOneDimensional($arr) && !$start) {
                ...
                foreach ($arr as $key => $value) {
                	if (debug::$JTextKey) {
                		$str.= "<span class='$keyClass'>".JText::_(debug::decorateValue($key))."</span>\n";
                	} else {
                ...
                foreach ($arr as $key => $value) {
					...
					if (debug::$JTextKey) {
                    	$str.= "      <td class='$keyClass' $onClick>" . JText::_(debug::decorateValue($key)) . "</td>\n";
                	} else {
    ...
    private function decorateValue($value) {
        if (is_string($value)) {
            ...
            else $decValue = str_replace(array("<", ">", "\n"), array("&lt;", "&gt;", "<br/>"), $value);
